...
{
  public $title = "Mata Kuliah Semester";
  public $route = "mksemester";
  /**
  ...
  public function index(Request $request)
  {
    ...
    if($request->ajax()) {
      ...
      ->addColumn('status', function($data) {
        return $data->status==1?"<span class='btn btn-primary btn-sm'>Aktif</span>":"<span class='btn btn-danger btn-sm'>Tidak Aktif</span>";
      })
