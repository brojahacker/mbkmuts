        ...
        <div class="box-body">
          <form action="{{ route($identity['route'].'.update', $post->id) }}" class="form-horizontal" method="POST">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-8">
                <input type="text" class="form-control" name="kode_prodi" value="{{ old('kode_prodi', $post->kode_prodi) }}" placeholder="Kode Program Studi" required>
              </div>
            </div>
            <div class="form-group">
              <label for="name" class="col-sm-3 control-label">Nama Program Studi</label>
              <div class="col-sm-8">
                <input type="text" class="form-control" name="nama_prodi" value="{{ old('nama_prodi', $post->nama_prodi) }}" placeholder="Nama Program Studi" required>
              </div>
            </div>
            <div class="form-group">
              ...
              <div class="col-sm-8">
                <select class="form-control livesearch" name="nama_kaprodi">
                  <option value="{{ $post->nama_kaprodi }}" selected>{{ $post->nama_kaprodi }}</option>
                </select>
              </div>
            </div>
            <div class="form-group">
              ...
              <div class="col-sm-8">
                <select class="form-control livesearch" name="nama_sekprodi">
                  <option value="{{ $post->nama_sekprodi }}" selected>{{ $post->nama_sekprodi }}</option>
                </select>
              </div>
            </div>
            <div class="form-group">
