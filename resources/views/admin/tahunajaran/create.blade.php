          ...
          <form action="{{ route($identity['route'].'.store') }}" class="form-horizontal" method="POST">
              ...
              <div class="col-sm-8">
                <div class="btn-group btn-group-toggle" data-toggle="buttons">
                  <label class="btn btn-info">
                    <input type="radio" name="pendaftaran" value="1" autocomplete="off" required> Buka
                  </label>
                  <label class="btn btn-info">
                    <input type="radio" name="pendaftaran" value="0" autocomplete="off" required> Tutup
                  </label>
                </div>
              </div>
            </div>
            <div class="form-group">
              ...
              <div class="col-sm-8">
                <div class="btn-group btn-group-toggle" data-toggle="buttons">
                  <label class="btn btn-info">
                    <input type="radio" name="krs" value="1" autocomplete="off" required> Buka
                  </label>
                  <label class="btn btn-info">
                    <input type="radio" name="krs" value="0" autocomplete="off" required> Tutup
                  </label>
                </div>
              </div>
            </div>
            <div class="form-group">
              ...
              <div class="col-sm-8">
                <div class="btn-group btn-group-toggle" data-toggle="buttons">
                  <label class="btn btn-info">
                    <input type="radio" name="penilaian" value="1" autocomplete="off" required> Buka
                  </label>
                  <label class="btn btn-info">
                    <input type="radio" name="penilaian" value="0" autocomplete="off" required> Tutup
                  </label>
                </div>
              </div>
            </div> -->
