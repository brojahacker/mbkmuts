        ...
        <div class="box-body">
          <form action="{{ route($identity['route'].'.update', $post->id) }}" class="form-horizontal" method="POST">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-8">
                <input type="text" class="form-control" name="kode_fakultas" value="{{ old('kode_fakultas', $post->kode_fakultas) }}" placeholder="Kode Fakultas" required>
              </div>
            </div>
            <div class="form-group">
              <label for="name" class="col-sm-3 control-label">Nama Fakultas</label>
              <div class="col-sm-8">
                <input type="text" class="form-control" name="nama_fakultas" value="{{ old('nama_fakultas', $post->nama_fakultas) }}" placeholder="Nama Fakultas" required>
              </div>
            </div>
            <div class="form-group">
              ...
              <div class="col-sm-8">
                <select class="form-control livesearch" name="nama_dekan">
                  <option value="{{ $post->nama_dekan }}" selected>{{ $post->nama_dekan }}</option>
                </select>
              </div>
            </div>
            <div class="form-group">
              ...
              <div class="col-sm-8">
                <select class="form-control livesearch" name="nama_wadek">
                  <option value="{{ $post->nama_wadek }}" selected>{{ $post->nama_wadek }}</option>
                </select>
              </div>
            </div>
            <div class="form-group">
