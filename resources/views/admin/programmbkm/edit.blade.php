        ...
        <div class="box-body">
          <form action="{{ route($identity['route'].'.update', $post->id) }}" class="form-horizontal" method="POST">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-8">
                <select class="form-control" name="kategorimbkms_id" required>
                  <option value="">-</option>
                  @foreach ($kategorimbkm as $row)
            ...
            <div class="form-group">
              ...
              <div class="col-sm-8">
                <input type="text" class="form-control" name="nama_programmbkm" value="{{ old('nama_programmbkm', $post->nama_programmbkm) }}" placeholder="Nama Progra" required>
              </div>
            </div>
            <div class="form-group">
