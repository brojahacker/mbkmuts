        ...
        <div class="box-body">
          <form action="{{ route($identity['route'].'.update', $post->id) }}" class="form-horizontal" method="POST">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-6">
                <select class="form-control" name="tahunajarans_id" required disabled >
                  <option value="">-</option>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-6">
                <select class="form-control" name="kategorimbkms_id" disabled required>
                  <option value="">-</option>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-6">
                <select class="form-control" name="programmbkms_id" disabled required>
                  <option value="">-</option>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-6">
                ...
                <input type="text" class="form-control" name="nama" value="{{ Auth::user()->name }}" placeholder="" required disabled>
              </div>
            </div>
            <div class="form-group">
              <label for="name" class="col-sm-3 control-label">NIM</label>
              <div class="col-sm-6">
                <input type="text" class="form-control" name="nim" value="{{ Auth::user()->nik }}" placeholder="" required disabled>
              </div>
            </div>
            <div class="form-group">
              <label for="name" class="col-sm-3 control-label">IPK</label>
              <div class="col-sm-6">
                <input type="text" class="form-control" name="ipk" value="{{ old('ipk', $post->ipk) }}" placeholder="" required disabled>
              </div>
            </div>
            <div class="form-group">
              <label for="name" class="col-sm-3 control-label">Fakultas</label>
              <div class="col-sm-6">
                <input type="hidden" class="form-control" name="fakultas" value="{{ Auth::user()->fakultas }}" placeholder="" required disabled>
                <input type="text" class="form-control" value="{{ $identity['fakultas']->nama_fakultas }}" placeholder="" required disabled>
              </div>
            </div>
            <div class="form-group">
              <label for="name" class="col-sm-3 control-label">Program Studi</label>
              <div class="col-sm-6">
                <input type="hidden" class="form-control" name="prodi" value="{{ Auth::user()->prodi }}" placeholder="" required disabled>
                <input type="text" class="form-control" value="{{ $identity['prodi']->nama_prodi }}" placeholder="" required disabled>
              </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-6">
                <input type="text" class="form-control" name="telepon" value="{{ Auth::user()->no_hp }}" placeholder="" required disabled>
              </div>
            </div>
            <div class="form-group">
              <label for="name" class="col-sm-3 control-label">Alamat Asal</label>
              <div class="col-sm-6">
                <textarea class="form-control" name="alamat" required disabled>{{ Auth::user()->alamat }}</textarea>
              </div>
            </div>
            <div class="form-group">
              <?php
              ...
              ?>
              <label for="name" class="col-sm-3 control-label">Transkrip Nilai</label>
              <?php
                } else {
              ?>
              <label for="name" class="col-sm-3 control-label">Upload SK Penetapan</label>
              <?php
                }
              ?>
              <!-- <div class="col-sm-4">
            ...
            <div class="form-group">
              <label for="name" class="col-sm-3 control-label">Keterangan Bukti Pembayaran</label>
              <!-- <div class="col-sm-4">
            ...
            <div class="form-group">
              <label for="name" class="col-sm-3 control-label">Keterangan</label>
              <div class="col-sm-6">
                <textarea class="form-control" name="alamat" required disabled>{{ $post->keterangan }}</textarea>
              </div>
            </div>
            <div class="form-group">
              ...
              <div class="col-sm-6">
                @if($post->status == 0)
                <a href="{{ route($identity['route'].'.kirim', $post->id) }}" onclick="return confirm('Anda yakin ingin kirim data ini?')" class="btn btn-success" id="btn-save" value="addNewData">Kirim</a>
                <a href="{{ route($identity['route'].'.edit', $post->id) }}" class="btn btn-info" id="btn-save" value="addNewData">Edit</a>
                @endif
